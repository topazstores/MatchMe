<div class="wrapper">
	<div class="section">
		<div class="container" <?php if($profile_visitors->num_rows >= 1) { echo 'style="padding-bottom:160px;"'; } else { echo 'style="padding-bottom:380px;"'; } ?>>
			<div class="row">
				<div class="col-lg-12">
					<h2 class="page-title mb-20 mt-5" style="font-size:25px;"> <?=$lang['Profile_Visitors']?> </h2>
					<?php if($profile_visitors->num_rows >= 1) { ?>
						<div class="well bg-white">
							<p class="mb-0"><?=$lang['Last_20_Visitors']?></p>
						</div>
					<?php
							...
							<div class="card card-user">
								<div class="content">
									...
									<p class="text-center text-muted">
										<?=$system->timeAgo($lang,$profile_visitor->time)?>
									</p>
								</div>
							</div>
						</div>
